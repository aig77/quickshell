...
Singleton {
    ...
    Loader {
        ...
        // Relative path from components/overview/common/ up to ~/.cache/stylix/.
        // File is generated by Nix and lives outside the symlinked config directory.
        source: "../../../../../.cache/stylix/Appearance.colors.qml"
        onStatusChanged: {
            if (status === Loader.Error)
                console.warn("Appearance: ~/.cache/stylix/Appearance.colors.qml not found, using default colors")
        }
    }
